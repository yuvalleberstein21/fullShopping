...
const OrderDetailmain = (props) => {
  ...
  useEffect(() => {
    disaptch(getOrderDetails(orderId))
  }, [disaptch, orderId, successDelivered]);

  const deliverHandler = () => {
    disaptch(deliverOrder(order));
  }
                ...
                <div className="row">
                  ...
                  <div className="col-lg-3">
                    <div className="box shadow-sm bg-light">
                      {
                        order.isDelivered ? (
                          <button className="btn btn-success col-12" style={{ fontSize: "14px" }}>
